  ...
  <main>
    ...
    <article class=" card bg-gradient-to-br variant-gradient-primary-secondary p-4 m-5">
      <div class="flex justify-end mr-5">
        <button class="btn-icon bg-gradient-to-br variant-gradient-secondary-tertiary w-10" id="edit-button">
          <img class="w-8" src="../../public/Assets/images/modification.png" alt=""></button>
      </div>
      <div id="user-info">
        <div class="flex">
        ...
        <div class="flex">
          <p class="underline font-bold mr-3 mb-5">Date de naissance :</p>
    ...
    <div class="flex flex-col justify-center md:flex-row">
      <div id="follower" class="card p-4 m-5 bg-gradient-to-br variant-gradient-primary-secondary w-auto md:w-96 lg:w-96">
        <h3 class="underline font-bold text-xl text-center mb-3">Me suivent :</h3>
      ...
      <div id="following" class="card p-4 m-5 bg-gradient-to-br variant-gradient-primary-secondary w-auto md:w-96 lg:w-96">
        <h3 class="underline font-bold text-xl text-center mb-3">Je suis :</h3>
